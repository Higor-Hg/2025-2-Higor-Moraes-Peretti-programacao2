...
if palpite != numero_secreto:
    print(f"Você usou todas as tentativas. O número era {numero_secreto}.")
...
while not (url.startswith("www.") and url.endswith(".com.br")):
    print(f"URL inválida: {url}")
    url = input("Digite novamente a URL no formato correto: ")
